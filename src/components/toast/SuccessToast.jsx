...
function SuccessToast({ setShowToast, message }) {
  return (
    <div
      id="toast-success"
      className="flex items-center absolute right-8 lg:w-full w-60 max-w-xs p-4 mb-4 mt-12 rounded-lg shadow text-gray-400 bg-gray-800"
      role="alert"
    >
