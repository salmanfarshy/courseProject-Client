...
{
  /* <div className="rounded-lg overflow-hidden md:hover:shadow-md hover:shadow-sm bg-gray-800 md:ms-12 md:mb-5 mb-3 md:w-72 w-80">
          <div className="px-6 py-4">
            <div className="font-bold md:text-xl text-lg mb-2 text-white">
              {ele.Id}. {ele.name}
            </div>
            <div className="text-gray-300 text-base">
              Author: <span className="font-semibold">{ele.author}</span>.
            </div>
          </div>
          <div className="ms-5 mb-3 text-sm font-semibold text-gray-700 flex flex-wrap gap-1">
            {ele.tags.map((tag) => (
